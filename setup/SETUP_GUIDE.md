...
| 4     | Install 154 manifest entries (153 active + 1 disabled) through the security-gated pipeline; combined with extension/CLI-provisioned skills this yields 172 active total                                                                                                                                                      | ~5 min  |
...
**154 manifest entries (153 active + 1 disabled) + 19 extension/CLI-provisioned skills = 172 active total** (in ~/.agents/skills/ — discovered by VS Code Copilot Chat):
