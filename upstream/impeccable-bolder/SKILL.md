---
name: impeccable-bolder
description: "Amplify a section within an existing design system to make it bolder and more confident. Use when a specific section reads flat or timid compared to its neighbors, and needs to be raised to the expressive level the rest of the page already reaches — without rebuilding anything outside the named target."
license: Apache-2.0
---
